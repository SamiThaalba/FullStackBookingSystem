...
public class AuthDataInitializer implements CommandLineRunner {
    ...
    private void seedPermissions() {
        ...
        permissions.put("hotel:view_all", "List and manage all hotels (platform operator)");
    ...
    private void seedRoles() {
        Set<String> allPermissionNames = permissionRepository.findAll().stream()
                .map(Permission::getName)
                .collect(Collectors.toCollection(java.util.TreeSet::new));

        createOrUpdateRole("SUPER_ADMIN", "Full platform access", allPermissionNames);

        createOrUpdateRole("ADMIN", "System administrator (scoped to own hotels)", Set.of(
